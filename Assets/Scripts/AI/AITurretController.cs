...
public class AITurretController : MonoBehaviour
{
    ...
    void SearchPlayer()
    {
        ...
        {
            Debug.Log("AITurretController.SearchPlayer Error");
        }
    }
    ...
    void Start()
    {
        ...
        {
            Debug.Log("AITurretController.Start Error");
        }
    }
    ...
    void Update()
    {
        ...
        {
            Debug.Log("AITurretController.Update Error");
        }
    }
    ...
    void EulerToQuater()
    {
        try
        {
            ...
            TurretAiming(tr_Gun_Body, tr_fireRotation);
        }
        catch
        {
            Debug.Log("AITurretController.EulerToQuater Error");
        }
    }

    void TurretAiming(Transform tr_Gun_Body, Quaternion tr_fireRotation)
    {
        try
        {
            //현재 터렛의 방향과 조준할 방향
        ...
        {
            Debug.Log("AITurretController.TurretAiming Error");
        }
    }
}
