...
public class SgTurret : MonoBehaviour
{
    ...
    private void SearchPlayer()
    {
        ...
        {
            Debug.Log("SgTurret.SearchPlayer Error");
        }
    }
    ...
    void Start()
    {
        ...
        {
            Debug.Log("SgTurret.Start Error");
        }
    }
    ...
    void Update()
    {
        ...
        {
            Debug.Log("SgTurret.Update Error");
        }
    }

    private void EulerToQuater()
    {
        try
        {
        ...
        {
            Debug.Log("SgTurret.EulerToQuater Error");
        }
    }

    private void TurretAiming(Transform tr_Gun_Body, Quaternion tr_fireRotation)
    {
        try
        {
            //현재 터렛의 방향과 조준할 방향
        ...
        {
            Debug.Log("SgTurret.TurretAiming Error");
        }
    }
}
